# [逆波兰表达式求值](https://leetcode-cn.com/problems/evaluate-reverse-polish-notation)（[Evaluate Reverse Polish Notation](https://leetcode.com/problems/evaluate-reverse-polish-notation)）*Medium*
## 描述
根据逆波兰表示法，求表达式的值。
