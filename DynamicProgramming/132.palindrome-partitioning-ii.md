# [分割回文串 II](https://leetcode-cn.com/problems/palindrome-partitioning-ii)（[Palindrome Partitioning II](https://leetcode.com/problems/palindrome-partitioning-ii)）*Hard*
## 描述
