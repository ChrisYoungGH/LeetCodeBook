### 基础
* [★☆☆ 最后一个单词的长度](./058.length-of-last-word.md)

### 直接遍历或依次匹配
* [★☆☆ 实现strStr()](./028.implement-strstr.md)
* [★★☆ 最长回文子串](./005.longest-palindromic-substring.md)
* [★★☆ Z字形变换](./006.zigzag-conversion.md)
* [★☆☆ 报数](./038.count-and-say.md)

### 分割
* [★★☆ 翻转字符串里的单词](./151.reverse-words-in-a-md)
* [★★☆ 简化路径](./071.simplify-path.md)
...
### 多情况讨论
* [★★☆ 字符串转整数 (atoi)](./008.to-integer-atoi.md)
* [★★★ 有效数字](./065.valid-number.md)
* [★★★ 整数转换英文表示](./273.integer-to-english-words.md)
