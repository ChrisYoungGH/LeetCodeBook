# [长度最小的子数组](https://leetcode-cn.com/problems/minimum-size-subarray-sum)（[Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum)）*Medium*
## 描述
