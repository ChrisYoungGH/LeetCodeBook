# 删除排序数组中的重复项 II（Remove Duplicates from Sorted Array II）*Medium*
### [删除排序数组中的重复项 II](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array-ii)（[Origin](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii)）
## 描述
