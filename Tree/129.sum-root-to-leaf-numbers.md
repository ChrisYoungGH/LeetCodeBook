# [求根到叶子节点数字之和](https://leetcode-cn.com/problems/sum-root-to-leaf-numbers)（[Sum Root to Leaf Numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers)）*Medium*
## 描述
