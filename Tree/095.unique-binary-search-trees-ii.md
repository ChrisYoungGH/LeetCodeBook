# [不同的二叉搜索树 II](https://leetcode-cn.com/problems/unique-binary-search-trees-ii)（[Unique Binary Search Trees II](https://leetcode.com/problems/unique-binary-search-trees-ii)）*Medium*
## 描述
