# [验证二叉搜索树](https://leetcode-cn.com/problems/validate-binary-search-tree)（[Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree)）*Medium*
## 描述
