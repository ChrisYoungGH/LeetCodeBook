# [二叉树的最小深度](https://leetcode-cn.com/problems/minimum-depth-of-binary-tree)（[Minimum Depth of Binary Tree](https://leetcode.com/problems/minimum-depth-of-binary-tree)）*Easy*
## 描述
给定一个二叉树，找出其最小深度。
